...
initvals = initialvals([alpha_1,alpha_2],[mu_1,mu_2],N,2);
initvals_shifted = initialvals([alpha_1,alpha_2],[mu_3,mu_4],N,2);
...
for x=1:N
    ...
    [tt_phi_pure,qq_phi_pure] = ode45(@(t,q) velocity_twobody(phiMinus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,step),phiMinus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,step),phiMinus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,step),phiMinus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,step),phiPlus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,step),phiPlus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,step),phiPlus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,step),phiPlus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,step),false),times,q0);
    [tt_phi_entangled,qq_phi_entangled] = ode45(@(t,q) velocity_twobody(phiMinus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,step),phiMinus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,step),phiMinus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,step),phiMinus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,step),phiPlus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,step),phiPlus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,step),phiPlus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,step),phiPlus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,step),true),times,q0);

    [tt_psi_pure,qq_psi_pure] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiMinus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiMinus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiMinus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiPlus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiPlus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiPlus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiPlus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,L,step),false),times,q0);
    [tt_psi_entangled,qq_psi_entangled] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiMinus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiMinus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiMinus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiPlus(t,q(1),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiPlus(t,q(1),theta_2,alpha_2,k_2,mu_2,omega,L,step),psiPlus(t,q(2),theta_1,alpha_1,k_1,mu_1,omega,L,step),psiPlus(t,q(2),theta_2,alpha_2,k_2,mu_2,omega,L,step),true),times,q0);

    % SAME STATISTICS ABOVE FOR WHEN L IS SHIFTED BY DELTA/2
    [tt_phi_pure_shifted,qq_phi_pure_shifted] = ode45(@(t,q) velocity_twobody(phiMinus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,step),phiMinus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,step),phiMinus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,step),phiMinus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,step),phiPlus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,step),phiPlus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,step),phiPlus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,step),phiPlus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,step),false),times,q0_shifted);
    [tt_phi_entangled_shifted,qq_phi_entangled_shifted] = ode45(@(t,q) velocity_twobody(phiMinus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,step),phiMinus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,step),phiMinus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,step),phiMinus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,step),phiPlus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,step),phiPlus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,step),phiPlus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,step),phiPlus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,step),true),times,q0_shifted);

    [tt_psi_pure_shifted,qq_psi_pure_shifted] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiMinus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiMinus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiMinus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiPlus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiPlus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiPlus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiPlus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,L1,step),false),times,q0_shifted);
    [tt_psi_entangled_shifted,qq_psi_entangled_shifted] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiMinus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiMinus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiMinus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiPlus(t,q(1),theta_1,alpha_1,k_1,mu_3,omega,L,step),psiPlus(t,q(1),theta_2,alpha_2,k_2,mu_4,omega,L1,step),psiPlus(t,q(2),theta_1,alpha_1,k_1,mu_3,omega,L1,step),psiPlus(t,q(2),theta_2,alpha_2,k_2,mu_4,omega,L1,step),true),times,q0_shifted);
...
for t = 1:1/mesh*time+1
    t
    phiMminL1 = phiMinus(times(t),-L,theta_1,alpha_1,k_1,mu_1,omega,step);
    phiMminL2 = phiMinus(times(t),-L,theta_2,alpha_2,k_2,mu_2,omega,step);
    phiPminL1 = phiPlus(times(t),-L,theta_1,alpha_1,k_1,mu_1,omega,step);
    phiPminL2 = phiPlus(times(t),-L,theta_2,alpha_2,k_2,mu_2,omega,step);
    phiMposL1 = phiMinus(times(t),L,theta_1,alpha_1,k_1,mu_1,omega,step);
    phiMposL2 = phiMinus(times(t),L,theta_2,alpha_2,k_2,mu_2,omega,step);
    phiPposL1 = phiPlus(times(t),L,theta_1,alpha_1,k_1,mu_1,omega,step);
    phiPposL2 = phiPlus(times(t),L,theta_2,alpha_2,k_2,mu_2,omega,step);
    psiMminL1 = psiMinus(times(t),-L,theta_1,alpha_1,k_1,mu_1,omega,L,step);
    psiMminL2 = psiMinus(times(t),-L,theta_2,alpha_2,k_2,mu_2,omega,L,step);
    psiPminL1 = psiPlus(times(t),-L,theta_1,alpha_1,k_1,mu_1,omega,L,step);
    psiPminL2 = psiPlus(times(t),-L,theta_2,alpha_2,k_2,mu_2,omega,L,step);
    psiMposL1 = psiMinus(times(t),L,theta_1,alpha_1,k_1,mu_1,omega,L,step);
    psiMposL2 = psiMinus(times(t),L,theta_2,alpha_2,k_2,mu_2,omega,L,step);
    psiPposL1 = psiPlus(times(t),L,theta_1,alpha_1,k_1,mu_1,omega,L,step);
    psiPposL2 = psiPlus(times(t),L,theta_2,alpha_2,k_2,mu_2,omega,L,step);

    phiMminL11 = phiMinus(times(t),-L1,theta_1,alpha_1,k_1,mu_3,omega,step);
    phiMminL12 = phiMinus(times(t),-L1,theta_2,alpha_2,k_2,mu_4,omega,step);
    phiPminL11 = phiPlus(times(t),-L1,theta_1,alpha_1,k_1,mu_3,omega,step);
    phiPminL12 = phiPlus(times(t),-L1,theta_2,alpha_2,k_2,mu_4,omega,step);
    phiMposL11 = phiMinus(times(t),L1,theta_1,alpha_1,k_1,mu_3,omega,step);
    phiMposL12 = phiMinus(times(t),L1,theta_2,alpha_2,k_2,mu_4,omega,step);
    phiPposL11 = phiPlus(times(t),L1,theta_1,alpha_1,k_1,mu_3,omega,step);
    phiPposL12 = phiPlus(times(t),L1,theta_2,alpha_2,k_2,mu_4,omega,step);

    psiMminL11 = psiMinus(times(t),-L1,theta_1,alpha_1,k_1,mu_3,omega,L1,step);
    psiMminL12 = psiMinus(times(t),-L1,theta_2,alpha_2,k_2,mu_4,omega,L1,step);
    psiPminL11 = psiPlus(times(t),-L1,theta_1,alpha_1,k_1,mu_3,omega,L1,step);
    psiPminL12 = psiPlus(times(t),-L1,theta_2,alpha_2,k_2,mu_4,omega,L1,step);
    psiMposL11 = psiMinus(times(t),L1,theta_1,alpha_1,k_1,mu_3,omega,L1,step);
    psiMposL12 = psiMinus(times(t),L1,theta_2,alpha_2,k_2,mu_4,omega,L1,step);
    psiPposL11 = psiPlus(times(t),L1,theta_1,alpha_1,k_1,mu_3,omega,L1,step);
    psiPposL12 = psiPlus(times(t),L1,theta_2,alpha_2,k_2,mu_4,omega,L1,step);

    for s = 1:2/mesh*L+1
        phiMsp1 = phiMinus(times(t),space(s),theta_1,alpha_1,k_1,mu_1,omega,step);
        phiMsp2 = phiMinus(times(t),space(s),theta_2,alpha_2,k_2,mu_2,omega,step);

        phiPsp1 = phiPlus(times(t),space(s),theta_1,alpha_1,k_1,mu_1,omega,step);
        phiPsp2 = phiPlus(times(t),space(s),theta_2,alpha_2,k_2,mu_2,omega,step);

        psiMsp1 = psiMinus(times(t),space(s),theta_1,alpha_1,k_1,mu_1,omega,L,step);
        psiMsp2 = psiMinus(times(t),space(s),theta_2,alpha_2,k_2,mu_2,omega,L,step);

        psiPsp1 = psiPlus(times(t),space(s),theta_1,alpha_1,k_1,mu_1,omega,L,step);
        psiPsp2 = psiPlus(times(t),space(s),theta_2,alpha_2,k_2,mu_2,omega,L,step);

        psiMspL11 = psiMinus(times(t),space(s),theta_1,alpha_1,k_1,mu_3,omega,L1,step);
        psiMspL12 = psiMinus(times(t),space(s),theta_2,alpha_2,k_2,mu_4,omega,L1,step);

        psiPspL11 = psiPlus(times(t),space(s),theta_1,alpha_1,k_1,mu_3,omega,L1,step);
        psiPspL12 = psiPlus(times(t),space(s),theta_2,alpha_2,k_2,mu_4,omega,L1,step);
