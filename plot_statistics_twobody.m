...
for x=1:N
    ...
    [tt_psi_pure_shifted,qq_psi_pure_shifted] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,sigma_1,k_1,mu_3,omega,L1),psiMinus(t,q(1),theta_2,sigma_2,k_2,mu_4,omega,L1),psiMinus(t,q(2),theta_1,sigma_1,k_1,mu_3,omega,L1),psiMinus(t,q(2),theta_2,sigma_2,k_2,mu_4,omega,L1),psiPlus(t,q(1),theta_1,sigma_1,k_1,mu_3,omega,L1),psiPlus(t,q(1),theta_2,sigma_2,k_2,mu_4,omega,L1),psiPlus(t,q(2),theta_1,sigma_1,k_1,mu_3,omega,L1),psiPlus(t,q(2),theta_2,sigma_2,k_2,mu_4,omega,L1),false),times,q0_shifted,opts);
    [tt_psi_entangled_shifted,qq_psi_entangled_shifted] = ode45(@(t,q) velocity_twobody(psiMinus(t,q(1),theta_1,sigma_1,k_1,mu_3,omega,L1),psiMinus(t,q(1),theta_2,sigma_2,k_2,mu_4,omega,L1),psiMinus(t,q(2),theta_1,sigma_1,k_1,mu_3,omega,L1),psiMinus(t,q(2),theta_2,sigma_2,k_2,mu_4,omega,L1),psiPlus(t,q(1),theta_1,sigma_1,k_1,mu_3,omega,L),psiPlus(t,q(1),theta_2,sigma_2,k_2,mu_4,omega,L1),psiPlus(t,q(2),theta_1,sigma_1,k_1,mu_3,omega,L1),psiPlus(t,q(2),theta_2,sigma_2,k_2,mu_4,omega,L1),true),times,q0_shifted,opts);
